            ...
            <div className="flex flex-row items-center gap-3">
              ...
              <div className="flex h-14 items-center justify-between rounded-xl border border-slate-200 bg-white px-1 shadow-sm shrink-0 w-32">
                <button
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-lg text-slate-500 transition-colors hover:bg-slate-50 hover:text-slate-900 disabled:opacity-50 cursor-pointer"
                >
                  <Minus size={16} />
                </button>
