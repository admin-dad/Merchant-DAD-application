  ...
  return (
    <div className="mx-auto max-w-8xl px-4 py-8 sm:px-6 lg:px-8 bg-white" style={{ fontFamily: 'var(--font-display)' }}>
      ...
      <div className="mb-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs font-semibold uppercase tracking-wide text-slate-500">Unscratched</span>
            <div className="p-2 bg-slate-100 rounded-lg"><Clock size={16} className="text-slate-500" /></div>
          </div>
          <h3 className="text-2xl font-bold text-slate-900">{pendingRewards.length}</h3>
          <p className="text-xs text-slate-400 mt-1">Customers left without scratching</p>
        </motion.div>
