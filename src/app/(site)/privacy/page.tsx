...
const privacySections = [
  {
    ...
    desc: "We collect information you provide directly during registration, including merchant business details, contact numbers, email addresses, and operational categories required for ecosystem access.",
    icon: Database,
    tag: "COLLECTION",
  },
  {
    title: "2. How We Use Your Data",
    desc: "Your data is utilized to manage merchant accounts, deliver personalized reward points, process commercial discounts, facilitate campaign participation, and improve overall platform functionality.",
    icon: UserCheck,
    tag: "USAGE",
  },
  {
    title: "3. Data Security & Protection",
    desc: "We implement robust technical and organizational security measures to protect your sensitive business records against unauthorized access, alteration, disclosure, or destruction.",
    icon: Lock,
    tag: "SECURITY",
  },
  {
    title: "4. Information Sharing",
    desc: "We do not sell or trade your personal or business information. Data is only shared with verified service partners or administrators strictly bound by confidentiality obligations.",
    icon: Server,
    tag: "SHARING",
  },
  {
    title: "5. Cookie Tracking & Analytics",
    desc: "Our platform uses secure cookies and analytics tools to enhance user experience, remember your preferences, and analyze traffic patterns across our web application.",
    icon: Eye,
    tag: "COOKIES",
  },
  {
    title: "6. Your Privacy Rights",
    desc: "You retain the right to access, update, or request the deletion of your account information by reaching out directly to our administrative and support team.",
    icon: Shield,
    tag: "RIGHTS",
  },
];
    ...
    <div className="relative min-h-screen bg-[#FAFCFF] text-[#0B2E7A] selection:bg-[#7BC142] selection:text-[#0B2E7A] overflow-x-hidden font-sans">
      ...
      >
        ...
        >
          ...
          >
            Your privacy is fundamental to our ecosystem. Learn how we collect, safeguard, and responsibly manage your personal and merchant business data.
          </motion.p>
        </motion.div>
      </section>

      {/* ---------------------------------------------------------- */}
      {/* SECTION: PRIVACY CARDS GRID                                */}
      {/* ---------------------------------------------------------- */}
        ...
        <div className="mx-auto max-w-6xl">
          <FadeUp className="mb-12 text-center">
            ...
            <p className="mt-2 text-sm text-[#0B2E7A]/70 max-w-xl mx-auto">
              Clear guidelines ensuring maximum protection and absolute transparency across all user interactions.
            </p>
          </FadeUp>
      ...
      <section className="relative overflow-hidden px-6 py-20">
        <FadeUp className="mx-auto max-w-3xl text-center">
          ...
          <h2
            ...
            style={{ fontFamily: "'Instrument Serif', Georgia, serif" }}
          >
            Have specific inquiries or need assistance regarding our privacy practices?
          </h2>
