...
const referralSteps = [
  {
    ...
    desc: "Generate your personalized referral link or merchant invite code directly from your dashboard and share it with peers, partners, or local businesses.",
    icon: Share2,
    tag: "INVITE",
  },
  {
    title: "2. Partner Onboarding",
    desc: "When invited merchants or users register on the platform and activate their ecosystem accounts using your link, the connection is tracked automatically.",
    icon: Users,
    tag: "CONNECT",
  },
  {
    title: "3. Earn Rewards & Points",
    desc: "Receive bonus reward points, promotional campaign perks, or commission credits as soon as your referrals complete their verification and onboarding milestones.",
    icon: Coins,
    tag: "REWARDS",
  },
  {
    title: "4. Unlock Tier Benefits",
    desc: "Accumulate successful referrals to elevate your partnership status, unlocking higher discount tiers, exclusive campaign features, and priority platform support.",
    icon: Award,
    tag: "GROWTH",
  },
  {
    title: "5. Redeem & Reinvest",
    desc: "Use your accumulated referral earnings across the platform to boost promotional visibility, redeem commercial discounts, or exchange them for ecosystem benefits.",
    icon: Gift,
    tag: "REDEMPTION",
  },
  {
    title: "6. Transparent Tracking",
    desc: "Monitor all your invitations, successful sign-ups, and reward distributions in real-time through your dedicated merchant dashboard analytics.",
    icon: CheckCircle2,
    tag: "ANALYTICS",
  },
];
      ...
      >
        ...
        >
          ...
          >
            ...
            <span>GROWTH & REWARD INITIATIVE</span>
          </motion.div>
          ...
          >
            Invite fellow merchants and business partners to join our digital ecosystem, and earn exclusive rewards, campaign perks, and tier benefits for every successful connection.
          </motion.p>
        </motion.div>
      </section>

      {/* ---------------------------------------------------------- */}
      {/* SECTION: REFERRAL STEPS CARDS GRID                         */}
      {/* ---------------------------------------------------------- */}
        ...
        <div className="mx-auto max-w-6xl">
          <FadeUp className="mb-12 text-center">
            ...
            <h2 
              ...
              style={{ fontFamily: "'Instrument Serif', Georgia, serif" }}
            >
              Simple Steps to Earn & Grow
            </h2>
            <p className="mt-2 text-sm text-[#0B2E7A]/70 max-w-xl mx-auto">
              Transparent mechanics designed to reward your active participation in expanding our merchant community.
            </p>
          </FadeUp>
      ...
      <section className="relative overflow-hidden px-6 py-20">
        <FadeUp className="mx-auto max-w-3xl text-center">
          ...
          <h2
            ...
            style={{ fontFamily: "'Instrument Serif', Georgia, serif" }}
          >
            Ready to share your link and start earning rewards with your network?
          </h2>
