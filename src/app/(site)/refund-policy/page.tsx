...
const refundSections = [
  {
    ...
    desc: "Refund requests are evaluated based on subscription plans, merchant membership tiers, and specific e-commerce transaction guidelines managed within the platform.",
    icon: FileCheck,
    tag: "ELIGIBILITY",
  },
  {
    title: "2. Subscription & Membership Fees",
    desc: "Active merchant membership plans or promotional service fees are generally non-refundable once activated, except under special administrative review or billing discrepancies.",
    icon: CreditCard,
    tag: "MEMBERSHIP",
  },
  {
    title: "3. Processing Timeline",
    desc: "Approved refunds are processed through secure banking channels or original payment methods within 5-7 business days, depending on your financial institution.",
    icon: Clock,
    tag: "TIMELINE",
  },
  {
    title: "4. E-Commerce & Product Returns",
    desc: "Product purchases made across the platform follow individual vendor return policies, requiring items to be unused and in original packaging for valid claims.",
    icon: RefreshCcw,
    tag: "PRODUCTS",
  },
  {
    title: "5. Dispute Resolution",
    desc: "If you encounter any discrepancies regarding billing, reward point redemptions, or campaign fees, our support team investigates and resolves issues promptly.",
    icon: ShieldCheck,
    tag: "DISPUTES",
  },
  {
    title: "6. Requesting Support",
    desc: "To initiate a refund or billing inquiry, please reach out directly through our contact page with your registered merchant details and transaction reference numbers.",
    icon: HelpCircle,
    tag: "SUPPORT",
  },
];
    ...
    <div className="relative min-h-screen bg-[#FAFCFF] text-[#0B2E7A] selection:bg-[#7BC142] selection:text-[#0B2E7A] overflow-x-hidden font-sans">
      ...
      >
        ...
        >
          ...
          >
            Learn about our transparent terms regarding membership subscriptions, billing inquiries, dispute resolutions, and product return guidelines.
          </motion.p>
        </motion.div>
      </section>

      {/* ---------------------------------------------------------- */}
      {/* SECTION: REFUND POLICY CARDS GRID                          */}
      {/* ---------------------------------------------------------- */}
        ...
        <div className="mx-auto max-w-6xl">
          <FadeUp className="mb-12 text-center">
            ...
            <h2 
              ...
              style={{ fontFamily: "'Instrument Serif', Georgia, serif" }}
            >
              How Refunds & Cancellations Work
            </h2>
            <p className="mt-2 text-sm text-[#0B2E7A]/70 max-w-xl mx-auto">
              Clear structures ensuring fair handling of financial transactions and subscription updates.
            </p>
          </FadeUp>
      ...
      <section className="relative overflow-hidden px-6 py-20">
        <FadeUp className="mx-auto max-w-3xl text-center">
          ...
          <h2
            ...
            style={{ fontFamily: "'Instrument Serif', Georgia, serif" }}
          >
            Have questions regarding a transaction or need to request support?
          </h2>
