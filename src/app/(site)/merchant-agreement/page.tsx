...
const agreementSections = [
  {
    title: "1. Partnership Scope & Onboarding",
    desc: "By registering as a merchant partner, you agree to participate in our digital ecosystem, utilizing merchant dashboards, QR campaign features, and promotional tools provided by the platform.",
    icon: Store,
    tag: "PARTNERSHIP",
  },
  {
    title: "2. Merchant Responsibilities",
    desc: "Merchants are required to maintain accurate business profiles, provide verified retail category details, and honor valid e-commerce orders, reward point redemptions, and promotional discounts.",
    icon: ShieldCheck,
    tag: "RESPONSIBILITIES",
  },
  {
    title: "3. Benefits & Rewards Structure",
    desc: "Merchant benefits, commercial discounts, and referral incentives are assigned dynamically based on membership level, active participation, and administrative configurations.",
    icon: Percent,
    tag: "BENEFITS",
  },
  {
    title: "4. QR Code & Campaign Terms",
    desc: "Promotional scratch cards, lucky number contests, and campaign QR assets deployed at merchant locations must be utilized in accordance with platform guidelines and promotional terms.",
    icon: QrCode,
    tag: "CAMPAIGNS",
  },
  {
    title: "5. Account Security & Compliance",
    desc: "Partners must ensure secure handling of login credentials and dashboard data. Unauthorized use, fraudulent activities, or policy violations may result in suspension or termination of partnership.",
    icon: BadgeCheck,
    tag: "COMPLIANCE",
  },
  {
    title: "6. Agreement Modifications",
    desc: "We reserve the right to update or modify these merchant agreement terms as the ecosystem evolves. Continued participation on the platform signifies ongoing acceptance of updated terms.",
    icon: FileText,
    tag: "MODIFICATIONS",
  },
];
    ...
    <div className="relative min-h-screen bg-[#FAFCFF] text-[#0B2E7A] selection:bg-[#7BC142] selection:text-[#0B2E7A] overflow-x-hidden font-sans">
      ...
      >
        ...
        >
          ...
          >
            Review the terms, responsibilities, and operational guidelines governing your partnership within our digital loyalty and e-commerce ecosystem.
          </motion.p>
        </motion.div>
      </section>

      {/* ---------------------------------------------------------- */}
      {/* SECTION: AGREEMENT CARDS GRID                              */}
      {/* ---------------------------------------------------------- */}
        ...
        <div className="mx-auto max-w-6xl">
          <FadeUp className="mb-12 text-center">
            ...
            <h2 
              ...
              style={{ fontFamily: "'Instrument Serif', Georgia, serif" }}
            >
              Overview of Merchant Terms
            </h2>
            <p className="mt-2 text-sm text-[#0B2E7A]/70 max-w-xl mx-auto">
              Transparent rules ensuring mutually beneficial collaboration and secure platform operations.
            </p>
          </FadeUp>

          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {agreementSections.map((item, i) => {
      ...
      <section className="relative overflow-hidden px-6 py-20">
        <FadeUp className="mx-auto max-w-3xl text-center">
          ...
          <h2
            ...
            style={{ fontFamily: "'Instrument Serif', Georgia, serif" }}
          >
            Ready to register your store and become an official merchant partner?
          </h2>
